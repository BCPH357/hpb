...
import 'warrantyTermsBody.dart';
class WarrantyTermsPage extends StatelessWidget {
  const WarrantyTermsPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final page = Scaffold(
      ...
      appBar: appBar,
      drawer: CustomDrawer(),
      body: WarrantyTerms(), // Assuming Home is a widget you have defined elsewhere
