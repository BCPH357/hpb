...
import 'accountEmergencyAddingBody.dart';
import 'custom_drawer.dart';
class AccountEmergencyAddingPage extends StatelessWidget {
  const AccountEmergencyAddingPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final page = Scaffold(
      ...
      appBar: appBar,
      body: AccountEmergencyAdding(), // Assuming Home is a widget you have defined elsewhere
