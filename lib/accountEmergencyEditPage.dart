...
class AccountEmergencyEditPage extends StatelessWidget {
  final int index;
  final String name;
  const AccountEmergencyEditPage({super.key, required this.index, required this.name});
  @override
  Widget build(BuildContext context) {
    ...
    final page = Scaffold(
      ...
      appBar: appBar,
      body: AccountEmergencyEdit(index: index, name: name), // Assuming Home is a widget you have defined elsewhere
