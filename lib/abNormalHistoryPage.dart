...
class AbnormalHistoryPage extends StatelessWidget {
  const AbnormalHistoryPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final page = Scaffold(
      ...
      drawer: CustomDrawer(),
      body:
          AbnormalHistory(), // Assuming Home is a widget you have defined elsewhere
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          BottomNavigationBarItem(
            icon: Image.asset(
              'assets/icons/abnormalHistoryGreen.png',
              height: 50.h,
            ),
            label: '異常歷史',
          ),
