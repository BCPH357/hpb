...
class AccountEmergencyPage extends StatelessWidget {
  const AccountEmergencyPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final page = Scaffold(
      ...
      appBar: appBar,
      drawer: CustomDrawer(),
      body: AccountEmergency(), // Assuming Home is a widget you have defined elsewhere
