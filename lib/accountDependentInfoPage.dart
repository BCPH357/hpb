...
import 'accountDependentInfoBody.dart';
...
class AccountDependentInfoPage extends StatelessWidget {
  const AccountDependentInfoPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final page = Scaffold(
      ...
      appBar: appBar,
      drawer: CustomDrawer(),
      body: AccountDependentInfo(), // Assuming Home is a widget you have defined elsewhere
