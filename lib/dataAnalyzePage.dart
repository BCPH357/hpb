...
class DataAnalyzePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final page = Scaffold(
      ...
      appBar: appBar,
      drawer: CustomDrawer(),
      body: DataAnalyze(), // Assuming Home is a widget you have defined elsewhere
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(
            icon: Image.asset(
              'assets/icons/dataAnalyzeGreen.png',
              height: 50.h,
            ),
            label: '資訊分析',
          ),
